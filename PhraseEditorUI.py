...
class Ui_PhraseEditor(object):
    def setupUi(self, PhraseEditor):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath("Images/addFile.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(os.path.abspath("Images/removeFile.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(os.path.abspath("Images/save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
